...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-br from-[#f0251f] via-[#e63946] to-[#d62d20] text-white rounded-t-4xl overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div className="lg:col-span-1 text-center sm:text-left">
            ...
            <p className="text-white text-xs sm:text-sm leading-relaxed mb-3 sm:mb-4 px-2 sm:px-0" style={{ fontFamily: 'Inter_18pt-Medium, sans-serif' }}>
            ...
            <div className="flex space-x-3 sm:space-x-4 justify-center sm:justify-start">
              <a 
                href="#" 
                className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-[#fab926] rounded-full flex items-center justify-center hover:bg-[#fab926] transition-colors duration-200"
              >
                <Facebook className="w-4 h-4 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white" />
              </a>
              <a 
                href="#" 
                className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-[#fab926] rounded-full flex items-center justify-center hover:bg-[#fab926] transition-colors duration-200"
              >
                <Twitter className="w-4 h-4 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white" />
              </a>
              <a 
                href="#" 
                className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-[#fab926] rounded-full flex items-center justify-center hover:bg-[#fab926] transition-colors duration-200"
              >
                <Instagram className="w-4 h-4 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-white" />
              </a>
            </div>
          </div>
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-1.5 sm:space-y-2">
              <li>
                <a href="#inicio" className="text-white hover:text-[#fab926] transition-colors duration-200 text-xs sm:text-sm" style={{ fontFamily: 'Inter_18pt-Medium, sans-serif' }}>
                  Inicio
                </a>
              </li>
              <li>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-5 lg:py-6">
        <div className="md:flex md:items-center md:justify-between">
          ...
          <div className="mt-3 md:mt-0 text-center md:text-right">
            <div className="flex flex-col sm:flex-row sm:space-x-4 lg:space-x-6 space-y-1 sm:space-y-0 justify-center md:justify-end">
