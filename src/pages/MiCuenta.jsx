...
const MiCuenta = () => {
    ...
    const handleVerBoleta = (reserva) => {
        // Pasar solo el ID de la reserva
        setBoletaSeleccionada(reserva.idReserva);
                                        ...
                                        {reservas.map((reserva, index) => (
                                                <div key={reserva.idReserva} className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 overflow-hidden">
                                                    ...
                                                    <div className="p-4">
                                                        ...
                                                        {/* Footer con fecha de reserva y botón Ver Boleta */}
                                                        <div className="mt-4 pt-4 border-t border-gray-100">
                                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                                                ...
                                                                <div className="flex items-center gap-3">
                                                                    ...
                                                                    <button
                                                                        onClick={() => handleVerBoleta(reserva)}
                                                                        className="flex items-center gap-2 px-3 py-1.5 bg-[#f0251f] text-white rounded-lg hover:bg-[#d91f1a] transition-colors text-sm font-medium shadow-sm hover:shadow-md"
                                                                        style={{ fontFamily: 'MusticaPro, sans-serif' }}
                                                                        title="Ver Boleta"
                                                                    >
